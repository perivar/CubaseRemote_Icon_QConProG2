...
deviceDriver.mOnActivate = function () {
...
//-----------------------------------------------------------------------------
var makeSurfaceElements = function () {
    var surfaceElements = {}
    // Display - 2lines
    ...
    // SMPTE/Beats
    surfaceElements.btnSmpteBeats = makeLedButton(
        surface,
        midiInput,
        midiOutput,
        23,
    ...
    // Solo Defeat
    surfaceElements.btnSoloDefeat = makeLedButton(
        surface,
        midiInput,
        midiOutput,
        23,
 ...
 * @returns sub page
 */
var makeSubPage = function (subPageArea, name) {
 ...
 * @param {string} name
 */
var makePageWithDefaults = function (name) {
...
var makePageSelectedTrack = function () {
    ...
    for (var idx = 0; idx < surfaceElements.numStrips; ++idx) {
        ...
        page.makeValueBinding(knobPushValue_1, selectedTrackChannel.mSends.getByIndex(idx).mOn)
            .setTypeToggle()
            .setSubPage(subPageSendsQC)
        page.makeValueBinding(
            faderSurfaceValue_1,
    ...
    for (var idx = 0; idx < 4; ++idx) {
        ...
        page.makeValueBinding(knobPushValue_2, eqBand[idx].mOn)
            .setTypeToggle()
            .setSubPage(subPageEQ)
        page.makeValueBinding(knob2PushValue_1, eqBand[idx].mOn)
            .setTypeToggle()
            .setSubPage(subPageEQ)
...
var makePageChannelStrip = function () {
...
var makePageControlRoom = function () {
...
var makePageMidi = function () {
     ...
     * @param {number} fader
     */
    var makeMidiCCBinding = function (page, displayName, cc, fader) {
...
var clearChannelState = function (activeDevice) {
    var activePage = activeDevice.getState('activePage')
...
mixerPage.mOnActivate = function (activeDevice) {
    ...
    surfaceElements.channelControls[0].mDisplayModeValue.setProcessValue(
        activeDevice,
        iconElements.VPOT_DISPLAY_TYPE.BoostOrCut
    )
    surfaceElements.channelControls[1].mDisplayModeValue.setProcessValue(
        activeDevice,
        iconElements.VPOT_DISPLAY_TYPE.BoostOrCut
    )
    surfaceElements.channelControls[2].mDisplayModeValue.setProcessValue(
        activeDevice,
        iconElements.VPOT_DISPLAY_TYPE.BoostOrCut
    )
    ...
    surfaceElements.channelControls[6].mDisplayModeValue.setProcessValue(
        activeDevice,
        iconElements.VPOT_DISPLAY_TYPE.BoostOrCut
    )
...
selectedTrackPage.mOnActivate = function (activeDevice) {
    ...
    surfaceElements.channelControls[0].mDisplayModeValue.setProcessValue(
        activeDevice,
        iconElements.VPOT_DISPLAY_TYPE.SingleDot
    )
    surfaceElements.channelControls[1].mDisplayModeValue.setProcessValue(
        activeDevice,
        iconElements.VPOT_DISPLAY_TYPE.SingleDot
