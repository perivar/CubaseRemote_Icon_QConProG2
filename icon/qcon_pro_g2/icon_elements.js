...
var makeChannelControl = function (surface, midiInput, midiOutput, x, y, channelIndex) {
    ...
    channelControl.pushEncoder.mEncoderValue.mOnProcessValueChange = function (
        activeDevice,
        value,
        diff
    ) {
    ...
    channelControl.pushEncoder.mEncoderValue.mOnTitleChange = function (
        activeDevice,
        objectTitle,
        valueTitle
    ) {
    ...
    channelControl.btnFaderTouch.mSurfaceValue.mOnProcessValueChange = function (
        activeDevice,
        value,
        diff
    ) {
    ...
    // };
    channelControl.fdrFader.mSurfaceValue.mOnTitleChange = function (
        activeDevice,
        objectTitle,
        valueTitle
    ) {
    ...
    channelControl.fdrFader.mSurfaceValue.mOnDisplayValueChange = function (
        activeDevice,
        value,
        units
    ) {
    ...
    channelControl.pushEncoder.mEncoderValue.mOnDisplayValueChange = function (
        activeDevice,
        value,
        units
    ) {
...
var makeMasterControl = function (surface, midiInput, midiOutput, x, y, channelIndex) {
    ...
    masterControl.fdrFader.mSurfaceValue.mOnTitleChange = function (
        activeDevice,
        objectTitle,
        valueTitle
    ) {
    ...
    masterControl.fdrFader.mSurfaceValue.mOnDisplayValueChange = function (
        activeDevice,
        value,
        units
    ) {
    ...
    // };
    masterControl.btnFaderTouch.mSurfaceValue.mOnProcessValueChange = function (
        activeDevice,
        value,
        diff
    ) {
    ...
    masterControl.btnFlip.mSurfaceValue.mOnProcessValueChange = function (
        activeDevice,
        value,
        diff
    ) {
