...
function makeSurfaceElements() {
    ...
    surfaceElements.pushEncoder12.mEncoderValue.mMidiBinding
    ...
    surfaceElements.pushEncoder17.mEncoderValue.mMidiBinding
        .setInputPort(midiInput)
        .setOutputPort(midiOutput)
    ...
    surfaceElements.knob486.mSurfaceValue.mMidiBinding
        .setInputPort(midiInput)
        .setOutputPort(midiOutput)
