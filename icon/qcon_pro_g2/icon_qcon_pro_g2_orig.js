...
function makeSurfaceElements() {
    ...
    surfaceElements.masterControl = makeMasterControl(
        surface,
        midiInput,
        midiOutput,
        xKnobStrip,
...
function makePageWithDefaults(name) {
    ...
    page.makeActionBinding(
        surfaceElements.masterControl.btnChannelLeft.mSurfaceValue,
        deviceDriver.mAction.mPrevPage
    )
    page.makeActionBinding(
        surfaceElements.masterControl.btnChannelRight.mSurfaceValue,
        deviceDriver.mAction.mNextPage
    )
    page.makeCommandBinding(
        surfaceElements.masterControl.btnBankLeft.mSurfaceValue,
        'Transport',
        'Locate Previous Marker'
    )
    page.makeCommandBinding(
        surfaceElements.masterControl.btnBankRight.mSurfaceValue,
        'Transport',
        'Locate Next Marker'
    )
    page.makeValueBinding(
        surfaceElements.transport.btnFastFwd.mSurfaceValue,
    ...
    page.makeValueBinding(
        surfaceElements.transport.btnPlay.mSurfaceValue,
    ...
    page.makeCommandBinding(
        surfaceElements.transport.btnCursorRight.mSurfaceValue,
        'Zoom',
        'Zoom In'
    ).setSubPage(subPageJogZoom)
    page.makeCommandBinding(
        surfaceElements.transport.btnCursorLeft.mSurfaceValue,
        'Zoom',
        'Zoom Out'
    ).setSubPage(subPageJogZoom)
    ...
    page.makeActionBinding(
        surfaceElements.transport.btnZoom.mSurfaceValue,
    ...
    page.makeActionBinding(
        surfaceElements.transport.btnScrub.mSurfaceValue,
    ...
    page.makeValueBinding(
        surfaceElements.masterControl.fdrFader.mSurfaceValue,
    ...
    page.makeValueBinding(
        surfaceElements.btnRead.mSurfaceValue,
        selectedTrackChannel.mValue.mAutomationRead
    ).setTypeToggle()
    page.makeValueBinding(
        surfaceElements.btnWrite.mSurfaceValue,
...
function makePageMixer() {
    ...
    for (var channelIndex = 0; channelIndex < surfaceElements.numStrips; ++channelIndex) {
        ...
        // VU Meter
        page.makeValueBinding(
            surfaceElements.channelControls[channelIndex].vuMeter,
            hostMixerBankChannel.mValue.mVUMeter
        )

        // Knob displayMode
        var hostValue = page.mCustom.makeHostValueVariable(
            'encoderDisplayMode'.concat(channelIndex.toString())
        )
...
mixerPage.mOnActivate = function (activeDevice) {
    ...
    surfaceElements.channelControls[0].mDisplayModeValue.setProcessValue(
        activeDevice,
        0 /* SingleDot */
    )
    surfaceElements.channelControls[1].mDisplayModeValue.setProcessValue(
        activeDevice,
        1 /* BoostOrCut */
    )
    surfaceElements.channelControls[2].mDisplayModeValue.setProcessValue(activeDevice, 2 /* Wrap */)
    surfaceElements.channelControls[3].mDisplayModeValue.setProcessValue(
        activeDevice,
        3 /* Spread */
    )
    surfaceElements.channelControls[4].mDisplayModeValue.setProcessValue(
        activeDevice,
        0 /* SingleDot */
    )
    surfaceElements.channelControls[5].mDisplayModeValue.setProcessValue(
        activeDevice,
        1 /* BoostOrCut */
    )
    surfaceElements.channelControls[6].mDisplayModeValue.setProcessValue(activeDevice, 2 /* Wrap */)
    surfaceElements.channelControls[7].mDisplayModeValue.setProcessValue(
        activeDevice,
        3 /* Spread */
    )
}
