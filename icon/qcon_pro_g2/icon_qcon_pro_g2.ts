...
import { LOG, VPOT_DISPLAY_TYPE } from './icon_elements';
...
deviceDriver.mOnActivate = function (activeDevice) {
    LOG('Icon QCon Pro G2 Activated');
};
...
function makeSurfaceElements() {
    ...
    surfaceElements.selectedTrack.mOnTitleChange = function (activeDevice, objectTitle, valueTitle) {
        LOG('SelectedTrack Title Change: ' + objectTitle + ':' + valueTitle);
...
mixerPage.mOnActivate = function (activeDevice: MR_ActiveDevice) {
    LOG('Icon QCon Pro G2 page "Mixer" activated');
    ...
    surfaceElements.channelControls[0].mDisplayModeValue.setProcessValue(activeDevice, VPOT_DISPLAY_TYPE.BoostOrCut);
    surfaceElements.channelControls[1].mDisplayModeValue.setProcessValue(activeDevice, VPOT_DISPLAY_TYPE.BoostOrCut);
    surfaceElements.channelControls[2].mDisplayModeValue.setProcessValue(activeDevice, VPOT_DISPLAY_TYPE.BoostOrCut);
    surfaceElements.channelControls[3].mDisplayModeValue.setProcessValue(activeDevice, VPOT_DISPLAY_TYPE.BoostOrCut);
    surfaceElements.channelControls[4].mDisplayModeValue.setProcessValue(activeDevice, VPOT_DISPLAY_TYPE.BoostOrCut);
    surfaceElements.channelControls[5].mDisplayModeValue.setProcessValue(activeDevice, VPOT_DISPLAY_TYPE.BoostOrCut);
    surfaceElements.channelControls[6].mDisplayModeValue.setProcessValue(activeDevice, VPOT_DISPLAY_TYPE.BoostOrCut);
    surfaceElements.channelControls[7].mDisplayModeValue.setProcessValue(activeDevice, VPOT_DISPLAY_TYPE.BoostOrCut);
};

selectedTrackPage.mOnActivate = function (activeDevice: MR_ActiveDevice) {
    LOG('Icon QCon Pro G2 page "Selected Track" activated');
    ...
    // Mixer default to Pan = BoostOrCut
    surfaceElements.channelControls[0].mDisplayModeValue.setProcessValue(activeDevice, VPOT_DISPLAY_TYPE.SingleDot);
    surfaceElements.channelControls[1].mDisplayModeValue.setProcessValue(activeDevice, VPOT_DISPLAY_TYPE.BoostOrCut);
    surfaceElements.channelControls[2].mDisplayModeValue.setProcessValue(activeDevice, VPOT_DISPLAY_TYPE.SingleDot);
    surfaceElements.channelControls[3].mDisplayModeValue.setProcessValue(activeDevice, VPOT_DISPLAY_TYPE.BoostOrCut);
};

channelStripPage.mOnActivate = function (activeDevice: MR_ActiveDevice) {
    LOG('Icon QCon Pro G2 page "Channel Strip" activated');
...
controlRoomPage.mOnActivate = function (activeDevice: MR_ActiveDevice) {
    LOG('Icon QCon Pro G2 page "ControlRoom" activated');
    activeDevice.setState('activePage', 'ControlRoom');
    clearAllLeds(activeDevice, midiOutput);
    clearChannelState(activeDevice);
};

midiPage.mOnActivate = function (activeDevice: MR_ActiveDevice) {
    LOG('Icon QCon Pro G2 page "Midi" activated');
