...
const makeSurfaceElements = () => {
    ...
    surfaceElements.selectedTrack.mOnTitleChange = (
...
const makePageMixer = () => {
    ...
    for (let channelIndex = 0; channelIndex < surfaceElements.numStrips; ++channelIndex) {
        ...
        // Knob displayMode
        const hostValue = page.mCustom.makeHostValueVariable(
