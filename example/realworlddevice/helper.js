function make_Sysex_displayActivateLayoutByIndex(layoutIndex) {
    return [0xf0, 0x00, 0x20, 0x29, 0x02, 0x0a, 0x01, 0x01, layoutIndex, 0xf7]
}
...
function make_Sysex_displaySetTextOfColumn(columnIndex, textFieldIndex, textString) {
    var data = [0xf0, 0x00, 0x20, 0x29, 0x02, 0x0a, 0x01, 0x02, columnIndex, 0x01, textFieldIndex]

    for (var i = 0; i < textString.length; ++i) data.push(textString.charCodeAt(i))
...
function make_Sysex_setLEDColor(ledIndex, r, g, b) {
    return [0xf0, 0x00, 0x20, 0x29, 0x02, 0x0a, 0x01, 0x03, ledIndex, 0x01, r, g, b, 0xf7]
}
